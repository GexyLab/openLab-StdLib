...
{
    public class LBCubeElevation : LogicBlock
    {
        public class Info : LogicBlockInfo
        {
            public string UID => "";

            public string Title => "Cube elevation";
            ...
            public string description => "Cube(x^3) elevation of port IN";
        ...
        public LBCubeElevation(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {   
        ...
        public override void run()
        {
            ...
            {
                outputPort.setData(Math.Pow(inputPortA.getData(false),3), false, false);
