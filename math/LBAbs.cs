...
{
    public class LBAbs : LogicBlock
    {
        public class Info : LogicBlockInfo
        {
            public string UID => "";

            public string Title => "Absolute value";
            ...
            public string description => "Absolute value of port IN";
        ...
        public LBAbs(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {   
        ...
        public override void run()
        {
            ...
            {
                outputPort.setData(Math.Abs(inputPortA.getData(false)), false, false);
