...
{
    public class LBSquareElevation : LogicBlock
    {
        public class Info : LogicBlockInfo
        {
            public string UID => "";

            public string Title => "Square elevation";
            ...
            public string description => "Square(x^2) elevation of port IN";
        ...
        public LBSquareElevation(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {   
        ...
        public override void run()
        {
            ...
            {
                outputPort.setData(Math.Pow(inputPortA.getData(false),2), false, false);
