...
{
    public class LBNegate : LogicBlock
    {
        public class Info : LogicBlockInfo
        {
            public string UID => "";

            public string Title => "Negate of value (-x)";
            ...
            public string description => "Negate of value of port IN";
        ...
        public LBNegate(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {   
        ...
        public override void run()
        {
            ...
            {
                outputPort.setData(-(inputPortA.getData(false)), false, false);
