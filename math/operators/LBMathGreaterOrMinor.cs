...
{
    public class LBMathGreaterOrMinor : LogicBlock
    {
        public class Info : LogicBlockInfo
        {
            public string UID => "";

            public string Title => "Greater or minor (><)";
        ...
        public LBMathGreaterOrMinor(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {   
        ...
        {
            outputPort.setData(inputPortA.getData(false) > inputPortB.getData(false) || inputPortA.getData(false) < inputPortB.getData(false), false, false);
        }
