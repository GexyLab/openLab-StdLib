...
{
    public class LBPowerElevation : LogicBlock
    {
        public class Info : LogicBlockInfo
        {
            public string UID => "";

            public string Title => "Power elevation";
            ...
            public string description => "Cube(x^y) elevation of port IN";
        ...
        public LBPowerElevation(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {   
            ...
            inputPortB = new LogicBlockPort("PWR", type, LogicBlockPort.DataDirection.Input);
        ...
        public override void run()
        {
            ...
            {
                outputPort.setData(Math.Pow(inputPortA.getData(false), inputPortB.getData(false)), false, false);
