...
{
    public class LBConPiOn2 : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBConPiOn2(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(Math.PI/2, false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string description => "Pi/2 constant";
