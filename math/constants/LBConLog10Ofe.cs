...
{
    public class LBConLog10Ofe : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBConLog10Ofe(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(Math.Log10(Math.E), false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string description => "ln(Pi) constant";
