...
{
    public class LBConPlanck : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBConPlanck(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(6.62606896e-34, false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string Title => "Planck(h) constant";
            ...
            public string description => "Planck's (J/Hz) Constant";
