...
{
    public class LBConEulero : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBConEulero(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(Math.E, false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string description => "Eulero(e) constant";
