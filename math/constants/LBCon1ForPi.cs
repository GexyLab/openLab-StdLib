...
{
    public class LBCon2ForPi : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBCon2ForPi(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(2*Math.PI, false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string description => "2*Pi constant";
