...
{
    public class LBCon1OnPi : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBCon1OnPi(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(1/Math.PI, false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string description => "1/Pi constant";
