...
{
    public class LBConLnPi : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBConLnPi(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(Math.Log(Math.PI), false, false);
