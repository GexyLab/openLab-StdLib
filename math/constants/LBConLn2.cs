...
{
    public class LBConLn2 : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBConLn2(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(Math.Log(2), false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string description => "ln(2) constant";
