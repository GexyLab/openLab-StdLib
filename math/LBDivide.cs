...
{
    public class LBDivide : LogicBlock
    {
        public class Info : LogicBlockInfo
        {
            ...
            public string description => "Divide value of port A on value of port B";
        ...
        public LBDivide(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {   
