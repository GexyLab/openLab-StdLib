...
{
    public class LBConLightSpeed : LogicBlock
    {
        LogicBlockPort outputPort;
        public LBConLightSpeed(IErrorManager _errorManager, IPluginsManager _pluginsManager, IEventsManager _eventsManager, IWindowsManager _windowsManager, InstrumentDefinition instrumentDefinition) : base(_errorManager, _pluginsManager, _eventsManager, _windowsManager, instrumentDefinition)
        {
            ...
            outputPort.setData(2.99792458e8, false, false);
        ...
        public class Info : LogicBlockInfo
        {
            ...
            public string Title => "Light speed (m/s)";
            ...
            public string description => "Light speed in Vacuum (m/s) Constant";
